...
def split_image(image_path:str, save_path:str, patch_height=256, patch_width=256):
    ...
    image = cv2.imread(image_path)
    # image = ace.auto_color_balance(image)
...
if __name__ == '__main__':
    ...
    for image_path in tqdm(train_dataset.image_paths):
        split_image(image_path=image_path, save_path='data/fives_patch_new/test/Original', patch_height=256, patch_width=256)