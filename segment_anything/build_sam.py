...
from .modeling import ImageEncoderViT, MaskDecoder, PromptEncoder, Sam, TwoWayTransformer, MaskDecoderHQ, SamHQ, MaskDecoderPAF
...
def build_sam_vit_b_fusion(args):
    return _build_sam_fusion(
        encoder_embed_dim=768,
        encoder_depth=12,
        encoder_num_heads=12,
        encoder_global_attn_indexes=[2, 5, 8, 11],
...
sam_model_registry = {
    ...
    "vit_b_hq": build_sam_vit_b_hq,
    "vit_b_fusion": build_sam_vit_b_fusion,
}
    ...
    if checkpoint is not None:
        ...
        try:
            if 'model' in state_dict.keys():
                print(f"If use adapter:{encoder_adapter}")
