...
class ImageEncoderViT(nn.Module):
    def __init__(
        ...
        # self.fusion_embed = PatchEmbed(
        #     kernel_size=(patch_size//4, patch_size//4),
        #     stride=(patch_size//4, patch_size//4),
        #     in_chans=in_chans,
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        self.interm_embeddings = interm_embeddings # only called after forward
        x = self.neck(x.permute(0, 3, 1, 2))
        return x
    
    def get_interm_embeddings(self):
        return self.interm_embeddings

    def get_patch_embedding(self):
        return self.patch_embed.patch_embedding
